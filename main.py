...
check_one ─ проверка вводимх пределов на корректность;
check_two ─ проверка вводимого числа на корректность.
'''
import math
...
def check_two(lim):
	if lim.isnumeric():						   #проверка на корректноть
		if int(lim) <= 30:
			return int(lim)
	print("была допущена ошибка, повторите ввод")
	return False
